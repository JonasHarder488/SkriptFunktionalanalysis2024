...
\begin{theorem} $T $ gehört zur Spurklasse genau dann wenn $\sqrt{\ab{T}}$ ein Hilbert-Schmidt-Operator ist. Es gilt dann für alle ONB‘s: \[\sum_{s \in S} \ip{e_s, Te_s} = \sum_{s' \in S'} \ip{e'_{s'}, Te'_{s'}}\;\;(*)\]
